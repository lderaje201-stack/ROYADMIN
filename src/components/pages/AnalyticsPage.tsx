...
export const AnalyticsPage: React.FC<AnalyticsPageProps> = ({
  ...
  return (
    <div id="admin-analytics-page" className="p-8 space-y-6 max-w-7xl mx-auto">
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.07)]">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Real-time charts tracking bookings, service popularity, and patient signups
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.07)] relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-500">Bookings (Last {dateRange} Days)</span>
            <div className="p-2 bg-neutral-100 text-slate-800 rounded-xl">
        ...
        <div className="bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.07)] relative overflow-hidden">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs font-semibold text-slate-700 bg-neutral-100 px-1.5 py-0.5 rounded">
              Active Profiles
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.07)]">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-semibold text-slate-600 bg-neutral-100/80 px-2.5 py-1 rounded-md">
              Grouped by Date
            </span>
          </div>
        ...
        <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-neutral-200/60 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.07)]">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
